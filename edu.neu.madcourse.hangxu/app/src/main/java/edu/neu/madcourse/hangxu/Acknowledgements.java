...
public class Acknowledgements extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ack_image.setText("Icon Source: SketchPad     Link: https://sketch.io/sketchpad/");
        ack_code.setText("Code Reference: StackOverFlow      Link: https://stackoverflow.com/questions/" +
